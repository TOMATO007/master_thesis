...
for j in data_num:
    for i in rm:
        ...
        for forward_seed in range(123, 124): 
#             generate_random_seed(forward_seed)
#             print("the forward seed is:", forward_seed)        
...
#                   valid_epoch_interval=1, folder_name=folder_name)
            ...
            for reverse_seed in range(1, 1000): 
                generate_random_seed(reverse_seed)
                print("the reverse seed is:", reverse_seed)
